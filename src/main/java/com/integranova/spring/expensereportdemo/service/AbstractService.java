...
import com.integranova.spring.expensereportdemo.repository.GenericRepository;
import com.integranova.spring.expensereportdemo.repository.SPBuilder;
...
import com.integranova.spring.expensereportdemo.utils.QueryContext;
...
public class AbstractService {
    ...
    protected AppUser getAgentAppUser() {
        return appuserSrv.getById(getAgentName());
    }

    protected AdminUser getAgentAdminUser() {
        return adminuserSrv.getById(getAgentName());
    }

    protected OperatorUser getAgentOperatorUser() {
        return operatoruserSrv.getById(getAgentName());
    }
    ...
    protected void processQuery(QueryRequest queryRequest, SQLSelect select) {
        applyFilters(queryRequest, select);
        applyOrderCriteria(queryRequest, select);
    }

    protected void applyFilters(QueryRequest queryRequest, SQLSelect select) {
    ...
    protected void applyFilter(FilterRequest filterRequest, SQLSelect select) {
    ...
    protected void applyQueryFilters(FilterRequest filterRequest, SQLSelect select) {
    	// To be implemented in each concrete class
    }
    
    protected void applyNavigationalFilters(FilterRequest filterRequest, SQLSelect select) {
    	// To be implemented in each concrete class
    }
    ...
    protected void applyHVFilter(SQLSelect select) {
        // To be implemented in each concrete class
    }
     ...
     */
    protected AbstractAppEntity buildRelatedInstance(String relatedInstanceJsonOid, String relatedInstancePath) {
