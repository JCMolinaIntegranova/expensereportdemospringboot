...
/**
 * Provides the functionality to set up an SQL select MAX statement.
 *
 */
public class SQLMax extends SQLScalar {

    /**
     * Creates a new SQL MAX sentence over an attribute reached through an
     ...
     *                         the method.
     */
    public SQLMax(String sourceEntityName, String targetPath, IOid instance) throws SystemException {
     ...
     *                         the method.
     */
    public SQLMax(SQLSelect superQuery, String sourceEntityName, String targetPath, IOid instance)
     ...
     *                         the method.
     */
    public SQLMax(String sourceEntityName, String targetPath, String parameterDefClass, IOid parameterValue,
     ...
     *                         the method.
     */
    public SQLMax(SQLSelect superQuery, String sourceEntityName, String targetPath) throws SystemException {
        super(superQuery, sourceEntityName, targetPath.substring(0, targetPath.lastIndexOf('.')),
     ...
     *                         the method.
     */
    public SQLMax(SQLSelect superQuery, String sourceEntityName, String targetPath, String parameterDefClass,
    ...
    public String getSQLSentence() {
        ...
        localSentence = " SELECT MAX(" + this.getAttributeAlias().getAlias() + "." + getTargetTableFieldName() + ")";
