...
public class AdminUserOid implements IOid, Serializable {
     ...
     */
    public AdminUserOid(String appUserLogin) {
     ...
     */
    public AdminUserOid(List<Object> col) {
     ...
     */
    public AdminUserOid(AppUserOid parentOID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null) {
            returnValue = false;
        } else if (!(obj instanceof AdminUserOid)) {
            returnValue = false;
        } else {
            AdminUserOid oid = (AdminUserOid) obj;
            if (oid == this) {
                returnValue = true;
            } else {
    ...
    public String[] getKeys() {
        ...
        values[0] = AdminUserConstants.ATTR_NAME_APPUSERLOGIN;
        return values;
    }
    ...
    public String getDefinitionClass() {
        return AdminUserConstants.CLASS_NAME;
    }
    ...
    public boolean compareToRS(Object[] instance) {
        ...
        AdminUserOid candidateOID = null;
        try {
            candidateOID = new AdminUserOid(STDFunctions.rightTrimFun((String) instance[0]));
        } catch (Exception e) {
            hasError = true;
        }
    ...
    public AdminUserOid fromJsonString(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        AdminUserOid temp;
        try {
            temp = mapper.readValue(jsonString, AdminUserOid.class);
        } catch (Exception e) {
            temp = null;
        }
        if (temp != null) {
