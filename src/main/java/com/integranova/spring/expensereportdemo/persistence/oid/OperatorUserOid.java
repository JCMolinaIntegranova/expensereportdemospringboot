...
public class OperatorUserOid implements IOid, Serializable {
     ...
     */
    public OperatorUserOid(String appUserLogin) {
     ...
     */
    public OperatorUserOid(List<Object> col) {
     ...
     */
    public OperatorUserOid(AppUserOid parentOID) {
        this.appUserLogin = parentOID.getAppUserLogin();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null) {
            returnValue = false;
        } else if (!(obj instanceof OperatorUserOid)) {
            returnValue = false;
        } else {
            OperatorUserOid oid = (OperatorUserOid) obj;
            if (oid == this) {
                returnValue = true;
            } else {
    ...
    public String[] getKeys() {
        ...
        values[0] = OperatorUserConstants.ATTR_NAME_APPUSERLOGIN;
        return values;
    }
    ...
    public String getDefinitionClass() {
        return OperatorUserConstants.CLASS_NAME;
    }
    ...
    public boolean compareToRS(Object[] instance) {
        ...
        OperatorUserOid candidateOID = null;
        try {
            candidateOID = new OperatorUserOid(STDFunctions.rightTrimFun((String) instance[0]));
        } catch (Exception e) {
            hasError = true;
        }
    ...
    public OperatorUserOid fromJsonString(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        OperatorUserOid temp;
        try {
            temp = mapper.readValue(jsonString, OperatorUserOid.class);
        } catch (Exception e) {
            temp = null;
        }
        if (temp != null) {
