...
public abstract class AbstractAppEntity implements IEntity {
    ...
    private QueryContext buildQueryContext() {
    	...
    	queryContext.setAgent(BeanUtil.getBean(Agent.class));
    	return queryContext;
    }
    ...
    protected Agent getAgent() {
    	if (agent == null) {
    		agent = BeanUtil.getBean(Agent.class);
    	}
    	return agent;
    }
    ...
    private String buildMethodName(AbstractAppEntity currentInstance, String pathItem, boolean isLastItem) {
    	return "get" + (isLastItem && currentInstance != null ? currentInstance.getClass().getSimpleName() : "") + pathItem.replace("_", "");
    }
     ...
     */
     public Method getMethod(String attribute) {
         ...
         String alternateMethodToLookFor = "get" + this.getClass().getSimpleName() + attribute;
