...
public class PaymentTypeJpaRepositoryImplTest {

    private static EntityManager em;

    private PaymentTypeJpaRepositoryImpl instancePaymentTypeJpaRepositoryImpl;

    // test4executeQueryString
    private static String test4executeQueryStringArg1;
    private static List<PaymentType> test4executeQueryStringResult;
    ...
    private static List<PaymentType> test4executeQueryStringParametersResult;

    // test4executeQuerySQLPopulation
    private static SQLPopulation test4executeQuerySQLPopulationArg1;
    private static Collection<PaymentType> test4executeQuerySQLPopulationResult;

    // test4solveQuery
    private static SQLPopulation test4solveQueryArg1;
    private static List<PaymentType> test4solveQueryResult;
    ...
    private static void setUpMockData4test4executeQueryString() {
        test4executeQueryStringArg1 = "SELECT PaymentType FROM PaymentType PaymentType";
        test4executeQueryStringResult = new ArrayList<>();
    }

    private static void setUpMockData4test4executeQueryStringParameters() {
        test4executeQueryStringParametersArg1 = "SELECT PaymentType FROM PaymentType PaymentType";
    ...
    private static void setUpMockData4test4executeQuerySQLPopulation() throws SystemException {
        test4executeQuerySQLPopulationArg1 = new SQLPopulation(PaymentTypeConstants.CLASS_NAME);
    ...
    private static void setUpMockData4test4solveQuery() throws SystemException {
        test4solveQueryArg1 = new SQLPopulation(PaymentTypeConstants.CLASS_NAME);
        test4solveQueryResult = new ArrayList<>();
    }

    @Before
    public void setUp() {
        instancePaymentTypeJpaRepositoryImpl = new PaymentTypeJpaRepositoryImpl();
        instancePaymentTypeJpaRepositoryImpl.setEntityManager(em);
    }
    
    @After
    public void tearDown() {
        instancePaymentTypeJpaRepositoryImpl = null;
    }
    ...
    public void test4executeQueryString() {
        ...
        try {
            result = instancePaymentTypeJpaRepositoryImpl.executeQuery(test4executeQueryStringArg1);
        } catch (Exception e) {
    ...
    public void test4executeQueryStringParameters() {
        List<PaymentType> result;
        try {
            result = instancePaymentTypeJpaRepositoryImpl.executeQuery(test4executeQueryStringParametersArg1, test4executeQueryStringParametersArg2);
        } catch (Exception e) {
    ...
    public void test4executeQuerySQLPopulation() {
        Collection<PaymentType> result;
        try {
            result = instancePaymentTypeJpaRepositoryImpl.executeQuery(test4executeQuerySQLPopulationArg1);
        } catch (Exception e) {
    ...
    public void test4solveQuery() {
        List<PaymentType> result;
        try {
            result = instancePaymentTypeJpaRepositoryImpl.solveQuery(test4solveQueryArg1);
        } catch (Exception e) {
