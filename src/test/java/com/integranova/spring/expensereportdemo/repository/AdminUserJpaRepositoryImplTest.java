...
public class AdminUserJpaRepositoryImplTest {

    private static EntityManager em;

    private AdminUserJpaRepositoryImpl instanceAdminUserJpaRepositoryImpl;

    // test4executeQueryString
    private static String test4executeQueryStringArg1;
    private static List<AdminUser> test4executeQueryStringResult;
    ...
    private static List<AdminUser> test4executeQueryStringParametersResult;

    // test4executeQuerySQLPopulation
    private static SQLPopulation test4executeQuerySQLPopulationArg1;
    private static Collection<AdminUser> test4executeQuerySQLPopulationResult;

    // test4solveQuery
    private static SQLPopulation test4solveQueryArg1;
    private static List<AdminUser> test4solveQueryResult;
    ...
    private static void setUpMockData4test4executeQueryString() {
        test4executeQueryStringArg1 = "SELECT AdminUser FROM AdminUser AdminUser";
        test4executeQueryStringResult = new ArrayList<>();
    }

    private static void setUpMockData4test4executeQueryStringParameters() {
        test4executeQueryStringParametersArg1 = "SELECT AdminUser FROM AdminUser AdminUser";
    ...
    private static void setUpMockData4test4executeQuerySQLPopulation() throws SystemException {
        test4executeQuerySQLPopulationArg1 = new SQLPopulation(AdminUserConstants.CLASS_NAME);
    ...
    private static void setUpMockData4test4solveQuery() throws SystemException {
        test4solveQueryArg1 = new SQLPopulation(AdminUserConstants.CLASS_NAME);
    ...
    @Before
    public void setUp() {
        instanceAdminUserJpaRepositoryImpl = new AdminUserJpaRepositoryImpl();
        instanceAdminUserJpaRepositoryImpl.setEntityManager(em);
    }
    
    @After
    public void tearDown() {
        instanceAdminUserJpaRepositoryImpl = null;
    }
    ...
    public void test4executeQueryString() {
        ...
        try {
            result = instanceAdminUserJpaRepositoryImpl.executeQuery(test4executeQueryStringArg1);
        } catch (Exception e) {
    ...
    public void test4executeQueryStringParameters() {
        List<AdminUser> result;
        try {
            result = instanceAdminUserJpaRepositoryImpl.executeQuery(test4executeQueryStringParametersArg1, test4executeQueryStringParametersArg2);
        } catch (Exception e) {
    ...
    public void test4executeQuerySQLPopulation() {
        Collection<AdminUser> result;
        try {
            result = instanceAdminUserJpaRepositoryImpl.executeQuery(test4executeQuerySQLPopulationArg1);
        } catch (Exception e) {
    ...
    public void test4solveQuery() {
        List<AdminUser> result;
        try {
            result = instanceAdminUserJpaRepositoryImpl.solveQuery(test4solveQueryArg1);
        } catch (Exception e) {
    ...
    public void test4findParent() {
        assertEquals(test4findParentResult, instanceAdminUserJpaRepositoryImpl.findParent(test4findParentArg1));
    }
}
